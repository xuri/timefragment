...
class Admin_JobsCategoriesResource extends BaseResource
{
    /**
     * 资源视图目录
     * @var string
     */
    protected $resourceView = 'admin.jobs_categories';

    /**
     * 资源模型名称，初始化后转为模型实例
     * @var string|Illuminate\Database\Eloquent\Model
     */
    protected $model = 'JobsCategories';

    /**
     * 资源标识
     * @var string
     */
    protected $resource = 'jobs_categories';

    /**
     * 资源数据库表
     * @var string
     */
    protected $resourceTable = 'jobs_categories';

    /**
     * 资源名称（中文）
     * @var string
     */
    protected $resourceName = '做兼职分类';
    ...
    public function postUpload($id)
    {
        ...
        $destinationPath   = 'uploads/jobs_categories_thumbnails/';
        ...
        File::delete(public_path('uploads/jobs_categories_thumbnails/'.$oldThumbnails));
    ...
    public function deleteUpload($id)
    {
        ...
        elseif ($thumbnails) {
        File::delete(public_path('uploads/jobs_categories_thumbnails/'.$thumbnails));
