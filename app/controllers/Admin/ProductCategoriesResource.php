...
class Admin_ProductCategoriesResource extends BaseResource
{
	/**
	 * Resource view directory
	 * @var string
	 */
	protected $resourceView = 'admin.product_categories';

	/**
	 * Model name of the resource, after initialization to a model instance
	 * @var string|Illuminate\Database\Eloquent\Model
	 */
	protected $model = 'ProductCategories';

	/**
	 * Resource identification
	 * @var string
	 */
	protected $resource = 'product_categories';

	/**
	 * Resource database tables
	 * @var string
	 */
	protected $resourceTable = 'product_categories';

	/**
	 * Resource name (Chinese)
	 * @var string
	 */
	protected $resourceName = '商品分类';
