						 ...
						 <ul class="nav nav-tabs">
							...
							<li>
								<a href="#tab-info" data-toggle="tab">
									...
									<span class="text-uppercase">招聘信息</span>
								</a>
							</li>
						</ul>
							...
							<div class="tab-content">
								...
								<div class="tab-pane active fade p-30 in" id="tab-general" style="margin:0 1em;">
									...
									<div class="form-group">
										...
										<select id="location" class="form-control input-sm selectpicker input-light brad" data-live-search="false" name="location" rel="{{ $job->location }}">
								...
								<div class="tab-pane fade p-30" id="tab-images-management" style="margin:0 1em;">
									...
									<div class="table-responsive form-group">
										<table class="table table-striped table-bordered table-hover">
											...
											<tbody>
												@foreach ($job->pictures as $picture)
												<tr>
													...
													<td>
														<img width="100" height="100" src="{{ route('home') }}/uploads/jobs/{{ $picture->filename }}">
													</td>
													<td style="text-align:center; padding: 50px 0;">
