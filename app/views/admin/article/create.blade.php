							...
							<div class="tab-content">
								...
								<div class="tab-pane active fade p-30 in" id="tab-general" style="margin:0 1em;">
									...
									<div class="form-group">
										...
										<input class="form-control" type="text" name="article_icon" id="article_icon" value="{{ Input::old('article_icon') }}" />
									</div>
									...
									<div class="form-group">
										...
										<textarea id="excerpt" class="form-control"
											name="excerpt" rows="5" placeholder="请在这里输入文章摘要……">{{ Input::old('excerpt') }}</textarea>
									</div>
								</div>
