		...
		<footer class="text-center">
			...
			<div class="copyright">
				<p>Copyright &copy; <?php echo date('Y');?> <a href="{{ route('home') }}" target="_blank">TimeFragment.com</a> All rights reserved. ♥ Lovingly made by <a href="https://xuri.me" target="_blank">Luxurioust</a></p>
				<p>
