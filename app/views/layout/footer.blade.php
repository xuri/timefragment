		...
		{{-- Analitycs code --}}
		<script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");document.write(unescape("%3Cspan id='cnzz_stat_icon_1252933521'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s19.cnzz.com/stat.php%3Fid%3D1252933521' type='text/javascript'%3E%3C/script%3E"));
		</script>
		{{-- Analitycs code --}}
	</body>
</html>